...
test_configs = [
  ...
  ['179D_Example_Building.xml', ASHRAE90_1, nil, 'v2.7.0'],  # FAILS: weather file????????
  # ['ASHRAE 211 Export.xml', ASHRAE90_1, nil, 'v2.7.0'],  # FAILS:  Building has building type Agricultural estate which is not handled by the gem.
