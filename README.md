...
The BuildingSync Gem requires installation of OpenStudio, specifically [OpenStudio v9.0](https://openstudio-builds.s3.amazonaws.com/index.html?prefix=3.9.0/).
...
(e.g., `export RUBYLIB=/Applications/OpenStudio-3.9.0/Ruby`)
